...
cfg = {
    "car": {
        ...
        "width": 30,                # Box width/height of the car
        "height": 50,
        "angle": 90,                # Initial direction of the car
        "num_sensors": 15,          # Number of sensor percepts (dots radiating out from the car)
        ...
        "acceleration": 0.5,        # The acceleration of the car
        "max_speed": 10,             # Top speed   # was 5
        "turn_rate": 0.4,           # How quickly the car is able to turn
    ...
    "reward": {
        "new_tile_reward" : 20,     # Reward for reaching a new tile
        "min_speed": 0,
    ...
    "training": {
        "learning_rate": lambda progress: .002,    # Schedule function for specifying
